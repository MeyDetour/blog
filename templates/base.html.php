    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="?type=articles&action=index">All</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="?type=articles&action=create">Create</a>
                </li>
                <li class="nav-item">
                ...
                <?php if(Session::userConnected()) { ?>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/">     <p><?=Session::user()['authenticator']?></p></a>
